...
function usePageVals() {
  ...
  const fullTypedText =
    "TAM is $4.2B across mid-market logistics buyers, with a $310M serviceable segment growing at 11.4% CAGR...";
  ...
  const planSections = [
    {
      icon: "📊",
      name: "Market Sizing",
      desc: "TAM, SAM, and growth rate — cited, not guessed.",
      delay: "0s",
    },
    {
      icon: "🧭",
      name: "Positioning",
      desc: "Where you sit against the field, and why it matters.",
      delay: "0.1s",
    },
    {
      icon: "🚀",
      name: "Go-to-Market",
      desc: "The channels and sequence to reach your first customers.",
      delay: "0.2s",
    },
    {
      icon: "💰",
      name: "Revenue Model",
      desc: "Pricing, unit economics, and realistic scenarios.",
      delay: "0.3s",
    },
    {
      icon: "⚔️",
      name: "Competitive Set",
      desc: "Direct and indirect players, mapped and scored.",
      delay: "0.4s",
    },
    {
      icon: "📎",
      name: "Funding Summary",
      desc: "A one-page ask, ready to drop into an investor email.",
      delay: "0.5s",
    },
  ];
  const barDefs = [
    { label: "Market Sizing", pct: 100 },
    { label: "Positioning", pct: 85 },
    { label: "Go-to-Market", pct: 60 },
    { label: "Revenue Model", pct: 30 },
  ];
...
export function CreateBusinessPlanView() {
  const {
    ideaText,
    onIdeaChange,
    scrollToForm,
          ...
          >
            <div>
              ...
              >
                ...
                ></span>
                {" Free to start · Funding-ready output "}
              </div>
              <h1
                className="reveal"
                style={{
              ...
              >
                {
                  " Describe your idea in plain language and AIAutomix drafts market sizing, positioning, go-to-market, and a revenue model — grounded in the same citation-backed data as your validation score. Refine any section by chatting. "
                }
              </p>
              <div
                className="reveal"
            ...
            >
              ...
              >
                <img
                  src="https://d8j0ntlcm91z4.cloudfront.net/user_3G7jqbleGK3BkzSMBLQtaF7DTkk/hf_20260727_103906_2414f4d7-6eff-4f7e-adbf-49caff7b0a35.png"
                  alt="Founder presenting business plan to investors"
                  style={{
                    position: "absolute",
                    inset: "0",
                    width: "100%",
        ...
        <div style={{ padding: "100px 64px", background: "#0E0F16" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            >
              ...
              >
                {"Six sections. One coherent story."}
              </h2>
            </div>
            <div
              style={{
        ...
        <div style={{ padding: "120px 64px", background: "#0A0B0F" }}>
          ...
          >
            <div className="reveal">
              ...
              >
                {"Every number, cited as it's written."}
              </h2>
              <p
                style={{
                  fontSize: "16px",
              ...
              >
                {
                  " As each section drafts, sources populate in real time — market data, competitor filings, pricing benchmarks — so nothing lands in your plan without a traceable citation behind it. "
                }
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                <span style={asStyle(typedTextStyle)}>{typedText}</span>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              <div style={{ position: "relative", minHeight: "340px" }}>
                <img
                  src="https://d8j0ntlcm91z4.cloudfront.net/user_3G7jqbleGK3BkzSMBLQtaF7DTkk/hf_20260727_103950_a8989c62-aa7d-482f-81c0-a4b99c18ba2c.png"
                  alt="Laptop showing business plan document"
                  style={{
                    position: "absolute",
                    inset: "0",
                    width: "100%",
              ...
              <div style={{ background: "#FFFFFF", padding: "40px 44px" }}>
                ...
                >
                  {
                    " TAM $4.2B, SAM $310M across mid-market 3PLs. Growth of 11.4% CAGR, driven by e-commerce fulfillment demand. "
                  }
                </p>
                <div
                  style={{
                ...
                >
                  {"SOURCE: DATAFORSEO · INDUSTRY FILINGS"}
                </div>
              </div>
            </div>
          </div>
